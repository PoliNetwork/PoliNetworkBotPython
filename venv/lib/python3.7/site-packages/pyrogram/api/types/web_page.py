...
class WebPage(TLObject):
    ...
    __slots__ = ["id", "url", "display_url", "hash", "type", "site_name", "title", "description", "photo", "embed_url", "embed_type", "embed_width", "embed_height", "duration", "author", "document", "documents", "cached_page"]

    ID = 0xfa64e172
    QUALNAME = "types.WebPage"

    def __init__(self, *, id: int, url: str, display_url: str, hash: int, type: str = None, site_name: str = None, title: str = None, description: str = None, photo=None, embed_url: str = None, embed_type: str = None, embed_width: int = None, embed_height: int = None, duration: int = None, author: str = None, document=None, documents: list = None, cached_page=None):
        self.id = id  # long
        self.url = url  # string
        ...
        self.documents = documents  # flags.11?Vector<Document>
    ...
    def read(b: BytesIO, *args) -> "WebPage":
        ...
        documents = TLObject.read(b) if flags & (1 << 11) else []
        
        cached_page = TLObject.read(b) if flags & (1 << 10) else None
        
        return WebPage(id=id, url=url, display_url=display_url, hash=hash, type=type, site_name=site_name, title=title, description=description, photo=photo, embed_url=embed_url, embed_type=embed_type, embed_width=embed_width, embed_height=embed_height, duration=duration, author=author, document=document, documents=documents, cached_page=cached_page)
    ...
    def write(self) -> bytes:
        ...
        flags |= (1 << 11) if self.documents is not None else 0
